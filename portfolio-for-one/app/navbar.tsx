export default function NavBar() {
    return(
        <div className="z-10 sticky top-2 h-[10vh] min-w-[40vw] m-[1vh] place-self-center grid grid-cols-5 place-items-center bg-white/25 backdrop-blur-md rounded-4xl p-1 text-slate-900 font-semibold">
